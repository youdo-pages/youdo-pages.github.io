...
?>
<div class="media_option shockwave"><h4><?php echo JText::_('WF_MEDIAMANAGER_SHOCKWAVE_OPTIONS'); ?></h4>
			
	<table border="0" cellpadding="4" cellspacing="0">
		<tr>
			<td><label for="shockwave_swstretchstyle"><?php echo JText::_('WF_MEDIAMANAGER_SHOCKWAVE_SWSTRETCHSTYLE'); ?></label></td>
			...
			<td><label for="shockwave_swvolume"><?php echo JText::_('WF_MEDIAMANAGER_SHOCKWAVE_VOLUME'); ?></label></td>
			<td><input type="text" id="shockwave_swvolume" /></td>
		</tr>
	
		<tr>
			<td><label for="shockwave_swstretchhalign"><?php echo JText::_('WF_MEDIAMANAGER_SHOCKWAVE_SWSTRETCHHALIGN'); ?></label></td>
			...
			<td><label for="shockwave_swstretchvalign"><?php echo JText::_('WF_MEDIAMANAGER_SHOCKWAVE_SWSTRETCHVALIGN'); ?></label></td>
			...
			<table border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td><input type="checkbox" class="checkbox" id="shockwave_autostart"
						checked="checked" /></td>
					<td><label for="shockwave_autostart"><?php echo JText::_('WF_MEDIAMANAGER_SHOCKWAVE_AUTOSTART'); ?></label></td>
				</tr>
			</table>
			</td>
			...
			<table border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td><input type="checkbox" class="checkbox" id="shockwave_sound"
						checked="checked" /></td>
					<td><label for="shockwave_sound"><?php echo JText::_('WF_MEDIAMANAGER_SHOCKWAVE_SOUND'); ?></label></td>
				</tr>
			</table>
			</td>
		</tr>
		<tr>
			...
			<table border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td><label for="shockwave_swliveconnect"><?php echo JText::_('WF_MEDIAMANAGER_SHOCKWAVE_LIVECONNECT'); ?></label></td>
				</tr>
			</table>
			</td>
			...
			<table border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td><input type="checkbox" class="checkbox" id="shockwave_progress"
						checked="checked" /></td>
					<td><label for="shockwave_progress"><?php echo JText::_('WF_MEDIAMANAGER_SHOCKWAVE_PROGRESS'); ?></label></td>
				</tr>
			</table>
			</td>
		</tr>
