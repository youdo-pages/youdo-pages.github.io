...
<div class="media_option video">
        ...
        <div class="uk-form-row">
          ...
          <label for="video_autoplay" class="uk-margin-right"><?php echo JText::_('WF_MEDIAMANAGER_LABEL_AUTOPLAY'); ?></label>
          <input type="checkbox" id="video_controls" checked="checked" />
          <label for="video_controls" class="uk-margin-right"><?php echo JText::_('WF_MEDIAMANAGER_LABEL_CONTROLS'); ?></label>
          <input type="checkbox" id="video_loop" />
          <label for="video_loop" class="uk-margin-right"><?php echo JText::_('WF_MEDIAMANAGER_LABEL_LOOP'); ?></label>
          <input type="checkbox" id="video_muted" />
          <label for="video_muted"><?php echo JText::_('WF_MEDIAMANAGER_VIDEO_MUTE'); ?></label>
        </div>
