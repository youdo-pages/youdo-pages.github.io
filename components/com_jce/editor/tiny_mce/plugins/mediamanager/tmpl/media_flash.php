	...
	<h4><?php echo JText::_('WF_MEDIAMANAGER_FLASH_OPTIONS'); ?></h4>
		...
		<div class="uk-form-row">
			<input type="checkbox" id="flash_play"
						checked="checked" />
			<label for="flash_play" class="uk-margin-right"><?php echo JText::_('WF_MEDIAMANAGER_FLASH_PLAY'); ?></label>

			<input type="checkbox" id="flash_loop"
						checked="checked" />
			<label for="flash_loop" class="uk-margin-right"><?php echo JText::_('WF_MEDIAMANAGER_LABEL_LOOP'); ?></label>
			<input type="checkbox" class="checkbox" id="flash_menu"
						checked="checked" />
			<label for="flash_menu" class="uk-margin-right"><?php echo JText::_('WF_MEDIAMANAGER_FLASH_MENU'); ?></label>
			<input type="checkbox" id="flash_swliveconnect" />
			<label for="flash_swliveconnect" class="uk-margin-right"><?php echo JText::_('WF_MEDIAMANAGER_FLASH_LIVECONNECT'); ?></label>
			<input type="checkbox"
						id="flash_allowfullscreen" />
			<label for="flash_allowfullscreen"><?php echo JText::_('WF_MEDIAMANAGER_FLASH_ALLOWFULLSCREEN'); ?></label>
		</div>
