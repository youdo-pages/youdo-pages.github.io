...
<div class="uk-grid uk-grid-small">
      <label for="align" class="hastip uk-form-label uk-width-1-5"
             title="<?php echo JText::_('WF_CAPTION_ALIGN_DESC'); ?>">
      ...
      <div class="uk-form-controls uk-width-2-5">
          <select id="align">
              ...
              <option value="center">
                  <?php echo JText::_('WF_OPTION_CENTER'); ?>
              </option>
              <option value="right">
                  <?php echo JText::_('WF_OPTION_RIGHT'); ?>
              </option>
              <option value="justified">
                  <?php echo JText::_('WF_OPTION_JUSTIFIED'); ?>
              </option>
          </select>
      </div>

        <label for="bgcolor" class="hastip uk-form-label uk-width-1-5"
               title="<?php echo JText::_('WF_CAPTION_BGCOLOR_DESC'); ?>">
